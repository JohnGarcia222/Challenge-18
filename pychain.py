...
st.markdown("## Transaction Record in the PyChain")
...
amount = st.text_input("Amount for Transaction")
...
difficulty = st.sidebar.slider("Difficulty Slider", 1, 5, 2)
pychain.difficulty = difficulty

st.sidebar.write("# Block Sets")
selected_block = st.sidebar.selectbox(
    "Which set would you like to see?", pychain.chain
)
